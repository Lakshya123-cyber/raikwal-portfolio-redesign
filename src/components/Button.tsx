...
export default function Button({
  ...
  return (
    ...
    >
      <span
        className={clsx(
          "absolute inset-0 z-0 h-full translate-y-9 bg-gradient-to-tr from-blue-300 to-pink-300 transition-transform  duration-300 ease-in-out group-hover:translate-y-0"
        )}
      />
